                        ...
                        return (
                            ...
                            >
                                <button
                                    ...
                                    onClick={() => handleLikeQuestion(question.id, question.likeId)} //when using an onClicl you can't call the func like this 'handleLikeQuestion(question.id)'
                                >
                                    { question.likeCount > 0 && <span>{question.likeCount}</span> } {/** it'll show just when there is a likeCount > 0 */}
